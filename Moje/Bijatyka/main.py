...
def StandardowaGieraBiedaEdition():
    Player = CharacterBase.Character('Geralt', 250, 30, 35, 15)

    Monster = CharacterBase.Character('Strzyga', 60, 20, 0, 5)
